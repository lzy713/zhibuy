                          ...
                          <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline layui_inp_widht300">
                                  <select name="pid" lay-verify="required">
                                      ...
                                      @foreach ($res as $k=>$v)
                                      @if($v->pid == 0)
                                      <option value="{{$v->id}}" @if ($v->id == $menu->pid) selected @endif>|--{{$v->title}}</option>
                                      @endif
                                      @endforeach
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="title" placeholder="请输入栏目名称" value="{{$menu->title}}" autocomplete="off" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="url" placeholder="请输入URL" value="{{$menu->url}}" autocomplete="off" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
                          	...
                          	<div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="listorder" value="{{$menu->listorder}}" autocomplete="off" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
