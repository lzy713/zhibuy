                          ...
                          <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block layui_inp_widht300">
                                  <select name="cid" lay-verify="required">
                                      ...
                                      <option value="{{$v->id}}" @if($v->id == $posters->cid) selected  @endif>{{$v->title}}</option>
                                      @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="title" placeholder="请输入标题" value="{{$posters->title}}" autocomplete="off" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="url" placeholder="请输入URL" autocomplete="off" value="{{$posters->url}}" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <div class="upload-img-box">
                                      @if(!empty($posters->pic))
                                        <div class="upload-icon-img">
                                          <div class="upload-pre-item"><i onclick="deleteImg($(this))" class="layui-icon"></i>
                                            <img src="{{$posters->pic}}" class="img" width="100" height="100" >
                                            <input type="hidden" name="pic" value="{{$posters->pic}}" />
                                          </div>
                                        </div>
                                      @endif
                                    </div>
                          	...
                          	<div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="listorder" autocomplete="off" value="{{$posters->listorder}}" value="" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
...
//路由地址
var SCOPE = {
	'save_url' : '/admin/poster/{{$posters->id}}',
...
layui.use(['element', 'form', 'upload', 'layer'], function(){
  ...
  upload.render({ //上传图片
      ...
      before: function(obj) {
          ...
          $('.upload-img-box').html('<div class="upload-icon-img"><div class="upload-pre-item"><i onclick="deleteImg($(this))" class="layui-icon"></i><img src="' + res.data + '" class="img" width="100" height="100" ><input type="hidden" name="pic" value="' + res.data + '" /></div></div>');
      }
      ,error: function(){
          layer.msg('上传错误！');
      }
