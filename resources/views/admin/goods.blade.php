...
<div style="padding: 15px;">
            ...
            <!--内容-->
             <form class="layui-form" action="/admin/goods/create" method="post" enctype="multipart/form-data">  
                        ...
                        <div class="layui-tab-content">
                          ...
                          <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="gprice" lay-verify="required|title" required placeholder="请输入标题" autocomplete="off" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="gdesc" lay-verify="required|title" required placeholder="请输入标题" autocomplete="off" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item" pane>
                          	    ...
                          	    <div class="layui-input-block">
                          	      <input type="radio" name="gstatus" value="1" title="新品" checked>
                        		 <input type="radio" name="gstatus" value="2" title="在售" >
                          	     <input type="radio" name="gstatus" value="3" title="下架">
                          	</div>
                            ...
                            <div class="layui-form-item" pane>
                        		 ...
                        		 <input type="radio" name="isrecom" value="1" title="是" >
                          	     <input type="radio" name="isrecom" value="2" title="否" checked>
                          	</div>

                            <div class="layui-form-item">
                                <label class="layui-form-label">商品销量</label>
                                <div class="layui-input-block">
                                  <input type="text" name="salenum" lay-verify="required|title" required placeholder="请输入标题" autocomplete="off" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
