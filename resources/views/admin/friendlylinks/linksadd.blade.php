...
@section('content')
    ...
    <div style="padding: 15px;">
        ...
        <blockquote class="layui-elem-quote">
            ...
            <!--内容-->
             <form class="layui-form" action="/admin/links/insert" method="post">  
                          ...
                          <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="fname" lay-verify="required|title" required placeholder="请输入标题" autocomplete="off" class="layui-input layui_inp_widht300" >
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                  <input type="text" name="furl" lay-verify="required|title" required placeholder="请输入标题" autocomplete="off" class="layui-input layui_inp_widht300">
                                </div>
                            </div>
